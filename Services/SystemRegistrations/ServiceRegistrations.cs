    ...
    public class ServiceRegistrations : ICurrentRegistrations
    {
        ...
        public async Task ApproveUser(CurrentRegistrationModel newUser)
        {
            ...
            await Task.Run(() =>
            {
                ...
                notificacion.Body =
                "<div style='border-style: solid; border-color: black';>" + "<h2 style='margin-left: 1cm;'>Your request for technical support has been received.</h2>" + "<hr style='margin-left: 0.5cm;'> " + "<h2 style='margin-left: 0.5cm;'>Details:</h2>" + "<h4>YOUR ACCOUNT ITS ACTIVE IN OUR IT DEPARTMENT, PLEASE MAKE THE FOLLOW STEPS:</h4>" + "<br>" + "<ul>" + ""+
                "<li>Your Password would be: "+ newUser.Pass +"(Remember to keep this password safe!) "+"(Only administrators can reset it in case of losing o forgot)"+ "</li>" +
                "<br>"+
